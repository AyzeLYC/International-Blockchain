...
#include "secp256k1/assumptions.h"
#include "secp256k1/checkmem.h"
...
#include "secp256k1/selftest.h"


namespace derivation {
    
    unsigned int secp256k1(wallet.privateKey PRIVATEKEY) {
...
int secp256k1_context_randomize(secp256k1_context* ctx, const unsigned char *seed32) {
    ...
    return 1;
        ...
        # include "secp256k1/modules/ecdh/main_impl.h"
        #endif
        ...
        # include "secp256k1/modules/extrakeys/main_impl.h"
        #endif
        
        #ifdef ENABLE_MODULE_SCHNORRSIG
        # include "secp256k1/modules/schnorrsig/main_impl.h"
        #endif
